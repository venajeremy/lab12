...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	if(search!=null) {
            		//System.out.println("Found: "+search.getName());
            		return search;
            	}
            	//System.out.println(targetName+" is not within "+child.getName());
            }
            
            //System.out.println("Searched every child not found anywhere!!!");
            // Not found anywhere.
            return null;
        }
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            TreeNode temp = this;
            //System.out.println(temp.parent.getName());
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Line Misformatted: No colon (:) present");//throw a TreeException with a useful message
		...
		else
		{
			...
			if(parentNode==null) {
				...
				throw new TreeException("Given parent is not a child within bloodline");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Node One is not present in the bloodline");//??? Throw a TreeException with a useful message
		
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("Node Two is not present in the bloodline");//??? Throw TreeException with a useful message
